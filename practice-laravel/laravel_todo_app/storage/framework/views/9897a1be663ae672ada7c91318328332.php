      ...
      <?php $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col">
          <div class="card bg-light">
            <div class="card-body d-flex justify-content-between algin-items-center">
            ...
            <?php $__currentLoopData = $goal->todos()->orderBy('done', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $todo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="card mx-2 mb-2">
                <div class="card-body">
                  <div class="d-flex justity-content-between algin-items-center mb-2">
                    ...
                    <div class="dropdown">
                      <a href="#" id="dropdownTodoMenuLink" class="dropdown-toggle px-1 fs-5 fw-bold link-dark text-decoration-none menu-icon" role="button" data-bs-toggle="dropdown" aria-expanded="false">︙</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/goals/index.blade.php ENDPATH**/ ?>